    ...
    <x-bladewind::dropmenu :modular="$modular" icon_right="{{$iconRight}}">
        <x-slot:trigger>
            <x-bladewind::icon
                    ...
                    type="{{$iconType}}"
                    dir="{{$iconDir}}"
                    class="text-indigo-600 hover:text-indigo-500 dark:!text-dark-500 dark:hover:text-dark-300 stroke-2 theme-light hidden {{$class}}"/>
            <x-bladewind::icon
                    name="{{$darkIcon}}"
                    type="{{$iconType}}"
                    dir="{{$iconDir}}"
                    class="text-indigo-400 hover:text-indigo-500 dark:!text-dark-500 dark:hover:!text-dark-400 stroke-2 theme-dark hidden {{$class}}"/>
            <x-bladewind::icon
                    name="{{$systemIcon}}"
                    type="{{$iconType}}"
                    dir="{{$iconDir}}"
                    class="text-indigo-400 hover:text-indigo-500 dark:!text-dark-500 dark:hover:!text-dark-400 stroke-2 theme-system hidden {{$class}}"/>
        </x-slot:trigger>
