...
<div class="relative bw-select bw-select-{{$input_name}} @if($addClearing) mb-3 @endif @if($searchable) searchable @endif"
    ...
    <div tabindex="0"
         ...
         dark:text-dark-300 {{$sizes[$size]}} pl-4 pr-2 clickable focus:!outline-indigo-500
         focus:!border-indigo-500  dark:focus:!border-indigo-500  dark:focus:!outline-indigo-500
    ...
    <div class="w-full absolute z-30 rounded-br-lg rounded-bl-lg bg-white shadow-sm shadow-gray-400 dark:shadow-none border-2
        border-indigo-500 dark:text-gray-300 dark:bg-dark-700 border-t-0 -mt-1.5
        ...
        <div class="sticky top-0 min-w-full bg-gray-100 dark:bg-transparent py-1 pr-0 -pl-1 search-bar @if(!$searchable) hidden @endif">
            <x-bladewind::input
                    ...
                    onfocus="changeCss('.bw-select-{{$input_name}} .clickable', '!border-2, !outline-2, !-outline-offset-1, !outline-indigo-500, !border-indigo-500, dark:!border-indigo-500, dark:!outline-indigo-500')"
                    onblur="changeCss('.bw-select-{{$input_name}} .clickable', '!border-2, !outline-2, !-outline-offset-1, !outline-indigo-500, !border-indigo-500, dark:!border-indigo-500, dark:!outline-indigo-500','remove')"
                    suffixIsIcon="true"/>
        </div>
