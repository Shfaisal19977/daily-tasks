...
class ProductController extends Controller
{
    public function __construct(
        private readonly ApiProductController $apiController
    ) {}
    ...
    {
        $response = $this->apiController->show($product);
    ...
    {
        $this->apiController->update($request, $product);
    ...
    {
        $this->apiController->destroy($product);
    ...
    public function reduceStock(ReduceStockRequest $request, Product $product): RedirectResponse
    {
        $response = $this->apiController->reduceStock($request, $product);
