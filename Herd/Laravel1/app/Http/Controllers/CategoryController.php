...
class CategoryController extends Controller
{
    public function __construct(
        private readonly ApiCategoryController $apiController
    ) {}
    ...
    {
        $response = $this->apiController->show($category);
    ...
    {
        $this->apiController->update($request, $category);
    ...
    {
        $this->apiController->destroy($category);
