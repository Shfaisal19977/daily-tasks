...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg p-8 border-l-4" style="border-color: #456882;">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">
            <i class="fas fa-edit mr-3" style="color: #456882;"></i>Edit Book
        </h1>
        ...
        <form action="{{ route('books.update', $book) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="title" id="title" value="{{ old('title', $book->title) }}" required
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg transition @error('title') border-red-500 @enderror" onfocus="this.style.borderColor='#456882'; this.style.boxShadow='0 0 0 3px rgba(69, 104, 130, 0.1)'" onblur="this.style.borderColor=''; this.style.boxShadow=''">
                @error('title')
            ...
            <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="cover_color" id="cover_color" value="{{ old('cover_color', $book->cover?->color) }}"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg transition @error('cover_color') border-red-500 @enderror" onfocus="this.style.borderColor='#456882'; this.style.boxShadow='0 0 0 3px rgba(69, 104, 130, 0.1)'" onblur="this.style.borderColor=''; this.style.boxShadow=''"
