...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-lg p-8 border-l-4" style="border-color: #456882;">
        <div class="flex justify-between items-start">
            <div>
                <h1 class="text-3xl font-bold text-gray-800 mb-4">{{ $student->user->name ?? 'N/A' }}</h1>
                <div class="space-y-3">
                    ...
                    <div class="flex items-center text-sm text-gray-500">
                        ...
                        <span>Enrolled {{ $student->created_at->format('F d, Y') }}</span>
                    </div>
                </div>
            </div>
            <div class="flex space-x-2">
                <a href="{{ route('students.edit', $student) }}" class="text-white px-4 py-2 rounded-lg transition" style="background: linear-gradient(to right, #234C6A, #456882);" onmouseover="this.style.background='linear-gradient(to right, #456882, #234C6A)'" onmouseout="this.style.background='linear-gradient(to right, #234C6A, #456882)'">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 border-l-4" style="border-color: #456882;">
        <h2 class="text-2xl font-bold text-gray-800 mb-4">
            <i class="fas fa-book-reader mr-2" style="color: #456882;"></i>Enrolled Courses
        </h2>
