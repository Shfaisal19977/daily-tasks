...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg p-8 border-l-4" style="border-color: #456882;">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">
            <i class="fas fa-plus-circle mr-3" style="color: #456882;"></i>Create New Student
        </h1>
        ...
        <form action="{{ route('students.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex space-x-4 pt-4">
                ...
                <a href="{{ route('students.index') }}" class="flex-1 bg-gray-500 text-white px-6 py-3 rounded-lg hover:bg-gray-600 transition text-center font-medium">
